...
<body>
  ...
  <main class="container" style="padding-top: var(--space-2xl); padding-bottom: var(--space-2xl);">
    ...
    <p style="margin-top: var(--space-md);"><small>Margin / padding utilities cover every
    ...
    <h3 style="margin-top: var(--space-2xl);">Responsive spacing</h3>
    ...
    <pre style="background: var(--color-bg-accent); padding: var(--space-md); border-radius: var(--radius-sm); overflow-x: auto; font: 500 13px/1.6 ui-monospace, Menlo, monospace;">// property, mobile, [tablet], [desktop]
