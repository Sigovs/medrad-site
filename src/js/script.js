...
(function () {
  ...
  CONDITIONS.forEach(function (cond, i) {
    ...
    btn.innerHTML =
      ...
      '<span class="assess-cond-text">' +
        ...
        '<span class="assess-cond-desc p2">' + cond.desc + '</span>' +
      '</span>' +
  ...
  function renderQuestion () {
    ...
    p.className   = 'assess-q-text font-display';
    ...
    yBtn.type        = 'button';
    yBtn.className   = 'assess-yn-btn p2';
    yBtn.textContent = 'Yes';

    var nBtn = document.createElement('button');
    nBtn.type        = 'button';
    nBtn.className   = 'assess-yn-btn p2';
    nBtn.textContent = 'No';
  ...
  function showResult () {
    ...
    condLabel.className   = 'assess-result__cond eyebrow';
    condLabel.textContent = cond.name;

    var headline = document.createElement('h2');
    headline.className  = 'assess-result__level';
    headline.innerHTML  = '<strong>' + levelLabel + '</strong>';
    ...
    disclaimer.className   = 'assess-result__disclaimer p2';
    ...
    restartBtn.className   = 'assess-result__restart p2';
