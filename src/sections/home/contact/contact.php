...
<section class="section section--accent" id="contact">
  <div class="container">
    ...
    <div class="contact-header">
      ...
      <p class="contact-header__desc">Referrals accepted from all physicians. Self-referral available for select procedures.</p>
    </div>

    <div class="contact-paths contact-paths--stacked">

      <!-- Path 1: Call -->
      <div class="contact-path">
        <div class="contact-path__icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        </div>
        <h3 class="contact-path__title h5 font-display">Call us directly</h3>
        <p class="contact-path__desc p2">Speak with our team now. We can answer questions, verify insurance, and schedule your visit.</p>
        <a href="tel:+17086574540" class="contact-path__action h5 font-display">(708) 657-4540</a>
        <p class="contact-path__meta p2">Mon&ndash;Fri &middot; 8:00 AM&ndash;5:00 PM</p>
      </div>
      ...
      <div class="contact-path">
        ...
        <h3 class="contact-path__title h5 font-display">Request a callback</h3>
        <p class="contact-path__desc p2">Leave your name and number. We&rsquo;ll reach out within 24 hours.</p>
        <form class="contact-path__form" id="contactForm">
      ...
      <div class="contact-path contact-path--wide">
        <div class="contact-path__intro">
          ...
          <h3 class="contact-path__title h5 font-display">Ask Dr. E</h3>
          <p class="contact-path__desc p2">Not ready to book? Ask a question about your imaging, your report, or what to expect &mdash; we typically reply within one business day.</p>
        </div>
        <form class="contact-path__form contact-path__form--wide" id="askdreForm" novalidate>
          <div class="contact-path__form-row">
